...
# 1.6.1 stable
DEFOLDSDK=a90c50928623cf23b3687a7eec05972d11427202
...
function build_plugin() {
    ...
    java -jar $BOB --platform=$platform --architectures=$platform resolve build --build-artifacts=plugins --variant $VARIANT --build-server=$SERVER --defoldsdk=$DEFOLDSDK
